...
/**
 * Servlet implementation class DiscussBoxLike
 */
@WebServlet("/DiscussBoxLike")
public class DiscussBoxLike extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String sql = "select like from "+discussCategory+" where uid=?";
			...
			sql = "update "+discussCategory+" set like=? where uid=?";
